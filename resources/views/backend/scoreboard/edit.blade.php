...
@section( 'content')
<h2 class="h3 mb-4 text-gray-800">Edit ({{ $score->team }})</h2>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="" required value="{{ $score->team }}" class="form-control @error('team') border border-danger @enderror" placeholder="Team" name="team" autocomplete="off" readonly>
                    @error('team')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" required id="timepicker" value="{{ $score->matches }}" class="form-control @error('matches') border border-danger @enderror" placeholder="goals" name="matches" autocomplete="off">
                    @error('matches')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" required id="timepicker" value="{{ $score->wins }}" class="form-control @error('wins') border border-danger @enderror" placeholder="Wins" name="wins" autocomplete="off">
                    @error('wins')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" required id="timepicker" value="{{ $score->loss }}" class="form-control @error('loss') border border-danger @enderror" placeholder="Loss" name="loss" autocomplete="off">
                    @error('loss')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" required id="timepicker" value="{{ $score->draws }}" class="form-control @error('draws') border border-danger @enderror" placeholder="draws" name="draws" autocomplete="off">
                    @error('draws')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" required id="timepicker" value="{{ $score->points }}" class="form-control @error('points') border border-danger @enderror" placeholder="Points" name="points" autocomplete="off">
                    @error('points')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" required id="timepicker" value="{{ $score->goal_difference }}" class="form-control @error('goal_difference') border border-danger @enderror" placeholder="Goal Difference" name="goal_difference" autocomplete="off">
