...
@endif
<form action="{{ route('leaguePlayer.store') }}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
    @csrf
    <div class="form-body">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="" value="{{ old('player_name') }}" class="form-control @error('player_name') border border-danger @enderror" placeholder="Name" name="player_name" autocomplete="off">
                    @error('player_name')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" id="timepicker" value="{{ old('player_number') }}" class="form-control @error('player_number') border border-danger @enderror" placeholder="Jersey Number" name="player_number" autocomplete="off">
                    @error('player_number')
