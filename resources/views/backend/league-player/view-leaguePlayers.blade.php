            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="/images/{{ $player->player_image }}" width="150" height="150"></td>
                        <td>
                            <form method="post" action="{{ route('leaguePlayer.destroy',$player->id) }}">
                                @csrf
                                @method('delete')
                                <div>
                            ...
                            <div class="mt-4">
                                <div class="mt-4">
                                    <a href="{{ route('leaguePlayer.edit',$player->id) }}"> <button type="submit" class="btn btn-info">Edit</button></a>
                                </div>
