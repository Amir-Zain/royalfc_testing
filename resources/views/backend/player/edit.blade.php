...
@section( 'content')
<h2 class="h3 mb-4 text-gray-800">Edit ({{ $player->name }})</h2>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="" required value="{{ $player->name }}" class="form-control @error('name') border border-danger @enderror" placeholder="Name" name="name" autocomplete="off">
                    @error('name')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="">Age</label>
                    <input type="number" required id="" value="{{ $player->age }}" class="form-control @error('age') border border-danger @enderror" placeholder="Age" name="age" autocomplete="off">
                    @error('age')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" required id="timepicker" value="{{ $player->number }}" class="form-control @error('number') border border-danger @enderror" placeholder="Jersey Number" name="number" autocomplete="off">
                    @error('number')
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea id="" rows="7" class="form-control @error('about') border border-danger @enderror" name="about" required>
                    {{ $player->about }}
                    </textarea>
                    @error('post_image')
