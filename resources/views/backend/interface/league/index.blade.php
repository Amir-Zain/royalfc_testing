        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <td><img src="{{ $leagueImage->image }}" width="200" height="200">
                    ...
                    <td>
                        ...
                        <div class="mt-4">
                            <a href="{{ route('league.edit',$leagueImage->id) }}"> <button type="submit" class="btn btn-info">Change</button></a>
