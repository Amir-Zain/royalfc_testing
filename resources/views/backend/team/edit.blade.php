...
@section( 'content')
<h2 class="h3 mb-4 text-gray-800">Edit {{ $team->team }}</h2>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="" required value="{{ $team->team }}" class="form-control @error('team') border border-danger @enderror" placeholder="Team Name" name="team" autocomplete="off">
                    @error('team')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="" required value="{{ $team->manager }}" class="form-control @error('manager') border border-danger @enderror" name="manager" autocomplete="off">
                    @error('manager')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="" required value="{{ $team->assist }}" class="form-control @error('assist') border border-danger @enderror" placeholder="Team Name" name="assist" autocomplete="off">
                    @error('assist')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="" required value="{{ $team->icon_player }}" class="form-control @error('icon_player') border border-danger @enderror" placeholder="Team Name" name="icon_player" autocomplete="off">
                    @error('icon_player')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="image">Assist Image</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="image">Icon Player Image</label>
