...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">All League Teams</h6>
    </div>
    <div class="card-body">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $team->manager}}</td>
                        <td>{{ $team->assist}}</td>
                        <td>{{ $team->icon_player}}</td>
                        <td><img src="/images/{{ $team->manager_image }}" width="150" height="150"></td>
                        <td><img src="/images/{{ $team->assist_image }}" width="150" height="150"></td>
                        <td><img src="/images/{{ $team->icon_player_image }}" width="150" height="150"></td>
                        <td><img src="/images/{{ $team->team_logo }}" width="150" height="150"></td>
                        <td>
                            ...
                            <div class="mt-4">
                                <div class="mt-4">
                                    <a href="{{ route('team.edit',$team->id) }}"> <button type="submit" class="btn btn-info">Edit</button></a>
                                </div>
